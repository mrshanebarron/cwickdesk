...
<head>
    ...
    <title>Login - CwickDesk Portal</title>
            ...
            <div class="glass-dark rounded-3xl p-8 sm:p-12">
                ...
                <form action="{{ route('portal.login.submit') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                               class="w-full px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="remember"
                                   class="w-4 h-4 rounded border-slate-600 bg-slate-900/50 text-blue-600 focus:ring-2 focus:ring-blue-500/20">
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 glass text-slate-400">Don't have an account?</span>
                    </div>
                </div>
