...
<head>
    ...
    <title>IT Help Desk Portal - CwickDesk</title>
    @vite(['resources/css/public.css'])
</head>
<body class="bg-slate-950 text-white antialiased">
    {{-- Header --}}
    <header class="border-b border-white/10 nav-blur-dark">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <a href="/" class="flex items-center space-x-3">
                    ...
                    <div>
                        <div class="font-display text-xl text-white">IT Help Desk</div>
                ...
                @else
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('portal.login') }}" class="text-sm text-slate-400 hover:text-white transition-colors">
                            Login
                        </a>
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12 animate-on-scroll">
            ...
            <p class="text-xl text-slate-400">Submit a support request or browse our knowledge base</p>
        </div>

        {{-- Quick Actions Grid --}}
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            {{-- Submit Ticket --}}
            <a href="{{ route('portal.submit') }}" class="glass-dark rounded-2xl p-8 card-hover group animate-on-scroll">
                ...
                <h3 class="font-display text-2xl font-bold text-white mb-2">Submit a Ticket</h3>
            ...
            <a href="{{ route('portal.kb') }}" class="glass-dark rounded-2xl p-8 card-hover group animate-on-scroll">
                ...
                <h3 class="font-display text-2xl font-bold text-white mb-2">Knowledge Base</h3>
                <p class="text-slate-400 mb-4">
            ...
            @auth
                <a href="{{ route('portal.my-tickets') }}" class="glass-dark rounded-2xl p-8 card-hover group animate-on-scroll">
                    ...
                    <h3 class="font-display text-2xl font-bold text-white mb-2">My Tickets</h3>
                    <p class="text-slate-400 mb-4">
        ...
        <div class="max-w-2xl mx-auto mb-12">
            <div class="glass-dark rounded-2xl p-8 animate-on-scroll">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="font-display text-xl font-bold text-white">Check Ticket Status</h3>
                        <p class="text-sm text-slate-400">Track your support request</p>
                    </div>
                </div>
                <form action="{{ route('portal.ticket.lookup') }}" method="GET" class="flex gap-3">
                    <input type="text" name="ticket_number" placeholder="Enter ticket number (e.g., IT-2025-001)"
                           class="flex-1 px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-all">
        ...
        <div class="max-w-4xl mx-auto">
            <h3 class="font-display text-3xl font-bold text-white mb-6 text-center">Common Solutions</h3>
            <div class="grid md:grid-cols-2 gap-4">
                @foreach([
                    ...
                    <a href="{{ route('portal.kb') }}" class="glass-dark rounded-xl p-4 hover:bg-slate-800/50 transition-all group">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-white group-hover:text-cyan-400 transition-colors">{{ $article[0] }}</h4>
                                <p class="text-sm text-slate-400 mt-1">{{ $article[1] }}</p>
                            </div>
                        </div>
                    </a>
                @endforeach
    ...
    {{-- Footer --}}
    <footer class="mt-16 py-6 border-t border-white/10">
